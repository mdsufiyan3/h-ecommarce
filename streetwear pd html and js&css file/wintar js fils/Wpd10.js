...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateProductDisplay() {
        const productId = 10; // Changed from 6 to 10
    ...
    window.addEventListener('product-updated', (event) => {
        if (event.detail.productId === 10) { // Changed from 6 to 10
...
// When storing data
const savedSizes = JSON.parse(localStorage.getItem('pd10_productSizes')) || ['M', 'L', 'XL']; // Changed from pd6 to pd10
