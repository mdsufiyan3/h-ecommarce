...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateProductDisplay() {
        const productId = 15; // Changed from 6 to 15
    ...
    window.addEventListener('product-updated', (event) => {
        if (event.detail.productId === 15) { // Changed from 6 to 15
...
// When storing data
const savedSizes = JSON.parse(localStorage.getItem('pd15_productSizes')) || ['M', 'L', 'XL']; // Changed from pd6 to pd15
