...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateProductDisplay() {
        const productId = 12; // Changed from 6 to 12
    ...
    window.addEventListener('product-updated', (event) => {
        if (event.detail.productId === 12) { // Changed from 6 to 12
...
// When storing data
const savedSizes = JSON.parse(localStorage.getItem('pd12_productSizes')) || ['M', 'L', 'XL']; // Changed from pd6 to pd12
